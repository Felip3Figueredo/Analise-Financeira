...
{
    /// <inheritdoc />
    public partial class BancoPostgres : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DespesaAtrasada = table.Column<bool>(type: "boolean", nullable: true),
                    Nome = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GerarCopiaDespesa = table.Column<bool>(type: "boolean", nullable: false),
                    MesCopia = table.Column<int>(type: "integer", nullable: false),
                    AnoCopia = table.Column<int>(type: "integer", nullable: false),
                    Nome = table.Column<string>(type: "text", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SistemaAtual = table.Column<bool>(type: "boolean", nullable: false)
                },
                constraints: table =>
                {
